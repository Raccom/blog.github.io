<template>
    <div id="sliderVerify">
        <p>请<span style="color:#f56a00">拖动</span>左侧滑块完成拼图</p>
        <div class="paperWrap">
        ...
        <div class="sliderWrap">
            <div class="progress-wrap">
                ...
                <div ref="buttonRef" class="button" @mousedown="down">
                    <img src="/images/js/verify/arrow.svg" alt="">
                </div>
            </div>
        </div>
        <div class="buttonWrap">
            <img src="/images/js/verify/question.svg" alt="">
            <img src="/images/js/verify/reload.svg" alt="" @click="fresh">
        </div>
...
const bgList = [
    ...
    new URL(`/images/js/verify/bg/9.jpg`, import.meta.url).href,
]
