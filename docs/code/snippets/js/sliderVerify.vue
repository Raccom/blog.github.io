    ...
    <div id="sliderVerify">
        <div class="paperWrap">
            <div class="canvas-wrap">
                <div class="mask" v-show="!canRefresh && !slideDiff"><img src="/images/js/verify/icons/load.svg" alt=""
                        @click="fresh"></div>
                ...
                <div class="buttonWrap">
                    <img src="/images/js/verify/icons/question.svg" alt="">
                    <img src="/images/js/verify/icons/reload.svg" alt="" @click="fresh">
                </div>
            </div>
        </div>
...
const pathList = {
    icon: {
        default: new URL(`/images/js/verify/icons/arrow.svg`, import.meta.url).href,
        success: new URL(`/images/js/verify/icons/success.svg`, import.meta.url).href,
